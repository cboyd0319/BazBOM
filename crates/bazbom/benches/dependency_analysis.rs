...
fn bench_graph_traversal(c: &mut Criterion) {
    ...
    for size in &[100, 1_000, 10_000] {
        ...
        group.bench_with_input(BenchmarkId::new("traverse", size), &deps, |b, deps| {
            b.iter(|| {
...
fn bench_dependency_resolution(c: &mut Criterion) {
    ...
    for size in &[100, 1_000, 10_000] {
        ...
        group.bench_with_input(BenchmarkId::new("resolve", size), &deps, |b, deps| {
            b.iter(|| {
...
fn bench_parallel_processing(c: &mut Criterion) {
    ...
    for size in &[1_000, 10_000] {
        ...
        group.bench_with_input(BenchmarkId::new("parallel", size), &deps, |b, deps| {
            b.iter(|| {
...
fn bench_caching(c: &mut Criterion) {
    ...
    for size in &[100, 1_000, 10_000] {
        ...
        group.bench_with_input(BenchmarkId::new("with_cache", size), &deps, |b, deps| {
