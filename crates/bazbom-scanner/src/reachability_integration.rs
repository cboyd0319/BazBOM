...
async fn analyze_go_reachability(
    ...
    for vuln in &result.vulnerabilities {
        ...
        // Go packages use full module paths (e.g., "github.com/foo/bar")
        // but vulnerabilities may reference just the last segment ("bar")
        // We need to check multiple matching strategies:
