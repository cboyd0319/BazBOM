...
async fn test_log4j_upgrade_analysis() {
    ...
    let analysis = analyzer
        .analyze_upgrade("org.apache.logging.log4j:log4j-core", "2.17.0", "2.20.0")
        .await
...
async fn test_spring_boot_major_upgrade() {
    ...
    assert!(
        analysis.estimated_effort_hours > 4.0,
