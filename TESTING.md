...
```bash
python3 -m pytest tools/supplychain/tests/test_badge_generator.py::TestCalculateBadgeData -v
python3 -m pytest tools/supplychain/tests/test_badge_generator.py::TestCalculateBadgeData::test_no_vulnerabilities -v
```
