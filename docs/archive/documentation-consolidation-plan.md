...
**Current State:**
- `../architecture/architecture.md` (19K) - Long-term planned architecture
- `../architecture/architecture-current.md` (13K) - Current Rust implementation
- `RUST_TRANSITION_COMPLETE.md` (10K) - Historical transition document

**Recommendation:**
- **Keep:** `../architecture/architecture.md` - Rename to reflect current state
- **Archive:** `RUST_TRANSITION_COMPLETE.md` → Move to `docs/archive/`
- **Consolidate:** Merge `../architecture/architecture-current.md` into `../architecture/architecture.md`
...
git mv docs/RUST_TRANSITION_COMPLETE.md docs/archive/
...
- `../getting-started/migration-guide.md` (7.1K, 314 lines) - Python to Rust CLI migration

**Recommendation:**
- **Keep:** `../getting-started/migration-guide.md` - Still valuable for historical context and users migrating
- **Archive:** `PYTHON_DEPENDENCIES.md` → Move to `docs/archive/`
...
git mv docs/PYTHON_DEPENDENCIES.md docs/archive/
...
**Current State:**
- `getting-started/quickstart-90-seconds.md` (5.3K) - Ultra-fast getting started
- `getting-started/quickstart.md` (9.9K) - Comprehensive 5-minute tutorial
...
**Current State:**
- `getting-started/homebrew-installation.md` (5.6K) - User guide for installing via Homebrew
- `operations/homebrew-tap-creation.md` (8.3K) - Maintainer guide for creating tap
...
**Current State:**
- `strategy/product-roadmap/../strategy/roadmap.md` (1451 lines, 36KB) - 8-week UX sprint plan
...
```
docs/strategy/product-roadmap/implementation-roadmap/
├── README.md (overview)
...
Create `docs/archive/` for completed transition documents:
...
- [x] Create master ../strategy/roadmap.md 
...
- [ ] Merge `../architecture/architecture-current.md` into `../architecture/architecture.md`
...
1. **Placement:**
   ...
   - Planning docs → `docs/strategy/product-roadmap/`
   - Reference docs → `docs/reference/`
   - Examples → `docs/examples/`

2. **Naming:**
   - Use CAPS for major docs (../user-guide/usage.md, ../strategy/roadmap.md)
