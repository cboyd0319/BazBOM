...
flowchart TD
    subgraph Cluster[Kubernetes Cluster]
        Operator["BazBOM Operator<br/>Deployment"]
        ScanJobs["Scan Jobs<br/>CronJob"]
        Dashboard["Dashboard<br/>Optional"]
    end
    Operator -->|Watches deployments| ScanJobs
    Operator -->|Stores findings| Dashboard
    ScanJobs -->|Runs bazbom image| Operator
```
