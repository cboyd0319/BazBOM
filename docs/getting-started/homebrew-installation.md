...
See [../operations/release-process.md](../operations/release-process.md) for details on signature verification with cosign.
...
- [Manual Installation](./quickstart.md#1-install-bazbom) - Build from source
- [GitHub Releases](../operations/release-process.md) - Download pre-built binaries
