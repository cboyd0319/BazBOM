...
**Documentation:**
- Update `docs/user-guide/usage.md` with init command
- Create `docs/getting-started/quickstart.md` with guided walkthrough
...
### Files to Update
- [ ] `docs/user-guide/usage.md` - Add new commands
- [ ] `docs/getting-started/quickstart.md` - Create guided walkthrough
