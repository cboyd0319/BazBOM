...
**Documentation:** `docs/security/vex.md` (comprehensive)
...
**Documentation:** `docs/operations/provenance.md`, `docs/security/supply-chain.md`
...
### 7.4 ../../getting-started/migration-guide.md  ASSUMES FULL PARITY
...
4. **Create docs/architecture/architecture-current.md**
...
- Keep ../implementation-status.md synchronized
